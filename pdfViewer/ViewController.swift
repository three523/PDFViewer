...
class ViewController: UIViewController {
    ...
    func presentActivityVC() {
        ...
        let vc1 = UIDocumentPickerViewController(forExporting: [url])
        let vc2 = DocumentBrowserViewController(forOpeningFilesWithContentTypes: ["public.composite-content"])
        vc2.allowsDocumentCreation = true
        vc2.allowsPickingMultipleItems = false
